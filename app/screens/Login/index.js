...
const Login = () => {
  ...
  const [request, response, promptAsync] = Google.useAuthRequest({
    expoClientId:
      "938415613346-3ecn64agj1971r8l0s520kc41d4s0n6p.apps.googleusercontent.com",
    androidClientId:
      "938415613346-f70dmihvkcjpjo3ljm798e85t5g45s2i.apps.googleusercontent.com",
    iosClientId:
      "938415613346-fcq85l5n5bgi4j8porff4aqj991b6kcd.apps.googleusercontent.com",
    redirectUri: redirectUri,
    // redirectUri: Platform.select({
    //   ios: makeRedirectUri({
    //     native: `com.geeekgod.bloodline://`,
    //     useProxy: true,
    //   }),
  ...
  return (
    <View style={styles.container}>
      ...
      {showError && (
        <Alert w="100%" status="error" position="absolute" bottom="8">
