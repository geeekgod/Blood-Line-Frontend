  ...
  return (
    <View style={styles.container}>
      ...
      <Text
        ...
        fontSize="2xl"
        textAlign="center"
      >{`Hii there! ${user.name.split(" ")[0]}`}</Text>

      <FormControl mt="4" isInvalid={phoneErr !== "" && submitted}>
      ...
      <FormControl mt="4" isInvalid={bloodGroupErr !== "" && submitted}>
        <Stack mt="2">
          <HStack
            ...
            alignItems="center"
          >
            <Icon as={<Fontisto name="blood" />} size={5} />
            <Select
              ...
              minWidth="full"
              accessibilityLabel="Select your blood group"
              placeholder="Select your blood group"
              _selectedItem={{
                bg: "gray.200",
                startIcon: (
                  <Icon as={<Fontisto name="blood-drop" />} size={5} />
                ),
              }}
              mt={1}
